window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var DispatcherApi = class {
			...
			async run(ignoreCheapMode = false) {
		...
		*/
		...
		function statusText(view) {
			...
			return (view.enabled ? "已启用" : "已禁用") + " · " + interval + " · 来源「" + view.projectName + "」" + (view.autoExecute ? " · 自动执行" : "") + (view.cheapMode ? " · 省钱模式开" : "") + (view.lastDispatchAt ? " · 上次 " + view.lastDispatchAt + "（" + view.lastTaskCount + " 项）" : " · 尚未拉取");
		}
		...
		function TaskDispatcherSettingsPanel() {
			...
			const [cheapMode, setCheapMode] = (0, react.useState)(false);
			const [cheapPreset, setCheapPreset] = (0, react.useState)("official-2026");
			const [cheapStrategy, setCheapStrategy] = (0, react.useState)("wait");
			const [cheapMarginMinutes, setCheapMarginMinutes] = (0, react.useState)("0");
			const [cheapTimezone, setCheapTimezone] = (0, react.useState)("Asia/Shanghai");
			const [peakText, setPeakText] = (0, react.useState)("");
			const [runIgnoreCheap, setRunIgnoreCheap] = (0, react.useState)(false);
			...
			const dispatchNow = () => {
				run(async () => {
					const result = await api.run(runIgnoreCheap);
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", {
								style: s.hint,
								children: [
									"官方口径（2026-08-17 起）：高峰 = 北京时间周一至周五 09:00–12:00、14:00–18:00（价格翻倍）；其余时间（工作日 12:00–14:00、18:00–次日 09:00、周六周日全天）为空闲时段（约半价）。不勾选时行为与现有逻辑完全一致。时段仅作用于",
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: "自动执行" }),
									"，拉取/过滤/串行都不变；排队状态落盘，DSH 重启不丢。"
								]
							}),
							cheapMode && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									style: s.row,
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										style: s.label,
										...
										value: cheapPreset,
										onChange: (e) => setCheapPreset(e.target.value),
										children: [
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
												value: "official-2026",
												children: "官方现行（周中 09–12 / 14–18 高峰）"
											}),
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
												value: "legacy-utc",
												children: "旧版 UTC 16:30–00:30 空闲"
											}),
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
												value: "custom",
												children: "自定义（用下方时段表）"
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
											...
											value: cheapTimezone,
											onChange: (e) => setCheapTimezone(e.target.value),
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("select", {
											style: s.input,
											value: cheapStrategy,
											onChange: (e) => setCheapStrategy(e.target.value),
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
												value: "wait",
												children: "排队等空闲"
											}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
											style: s.num,
											value: cheapMarginMinutes,
											onChange: (e) => setCheapMarginMinutes(e.target.value)
										}),
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											style: s.label,
											children: "分钟（0 = 关闭尾部保护；建议 15 或 worker 超时，避免跑进高峰）"
										})
									]
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									style: s.label,
									children: "高峰时段表（每行 `1,2,3,4,5 09:00-12:00`；0=周日…6=周六；start>end 跨午夜；空 = 一直空闲）"
								}),
								...
								view !== null && view.cheapMode && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", {
									style: s.hint,
									children: [
										"当前口径：",
										view.cheapPresetLabel,
										" · 高峰时段：",
										view.peakWindowsText || "（无，一直空闲）",
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("br", {}),
										"当前时段：",
										view.inPeakNow === void 0 ? "（读取中）" : view.inPeakNow ? "高峰（贵），不执行" : view.cheapCanRunNow !== false ? "空闲（优惠），可执行" : "空闲但接近高峰，暂不执行",
										view.cheapReason ? " · " + view.cheapReason : "",
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("br", {}),
										"下次执行时间：",
										view.nextCheapStartAt !== "" ? view.nextCheapStartAt : view.cheapNextStartLabel !== void 0 && view.cheapNextStartLabel !== "" ? view.cheapNextStartLabel : view.cheapCanRunNow === false ? "（等待下个空闲时段）" : "（当前空闲，立即可执行）",
										" ",
										"· 排队任务：",
										view.cheapQueueCount,
										" 项",
					...
					cheapMode && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
						style: s.check,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
							type: "checkbox",
							checked: runIgnoreCheap,
							onChange: (e) => setRunIgnoreCheap(e.target.checked)
