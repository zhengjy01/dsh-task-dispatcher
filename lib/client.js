	...
	factory: (require) => {
		...
		*/
		...
		function statusText(view) {
			...
			return (view.enabled ? "已启用" : "已禁用") + " · 每日 " + time + " · 来源「" + view.projectName + "」" + (view.lastDispatchAt ? " · 上次 " + view.lastDispatchAt + "（" + view.lastTaskCount + " 项）" : " · 尚未派发");
		}
		/** The settings panel component. */
		function TaskDispatcherSettingsPanel() {
			const [view, setView] = (0, react.useState)(null);
			const [dispatchHour, setDispatchHour] = (0, react.useState)("8");
			const [dispatchMinute, setDispatchMinute] = (0, react.useState)("30");
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
								style: s.num,
								value: dispatchHour,
								onChange: (e) => setDispatchHour(e.target.value)
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								style: s.label,
								children: ":"
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
								style: s.num,
								value: dispatchMinute,
								onChange: (e) => setDispatchMinute(e.target.value)
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								style: s.label,
								children: "（时:分）"
					...
					lastList !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("ul", {
						style: s.list,
