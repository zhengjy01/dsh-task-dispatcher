  ...
  return defineTool({
    ...
    async execute(args: Record<string, unknown> | undefined) {
      try {
        ...
        // 会话汇总正文由调用方自由书写（常含 PR 号 #91、#759 之类），必须和
        // 派发通知走同一道井号处理，否则 flomo 会把这些当成标签。
