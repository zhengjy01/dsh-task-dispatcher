	...
	factory: (require) => {
		...
		*/
		...
		function statusText(view) {
			...
			return (view.enabled ? "已启用" : "已禁用") + " · " + interval + " · 来源「" + view.projectName + "」" + (view.lastDispatchAt ? " · 上次 " + view.lastDispatchAt + "（" + view.lastTaskCount + " 项）" : " · 尚未拉取");
		}
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", {
						...
						children: [
							...
							"才发 flomo + macOS 通知，没变化则保持安静。 你随手在滴答清单里加任务，插件会在下次拉取时自动带进来。下方的「上次拉取任务列表」只是最近一次拉取到的任务快照，非实时。"
						]
					}),
